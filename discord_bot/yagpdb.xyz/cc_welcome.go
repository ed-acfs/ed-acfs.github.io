/* Custom Command */
/* Simile al join message, ricorda le regole base del server taggando tutti gli utenti col ruolo "@Membro Flotta"*/
/* Utilizzo: -welcome */
...
{{$ref_append := sendMessageNoEscapeRetID nil (joinStr "" "o7 <@&571710879880708097>" ", un breve reminder...")}} /* Qui inserire l'id del ruolo richiesto */

{{ sendMessage nil $embed }}
{{ deleteTrigger 0 }} /* Cancella il trigger che ha scatenato il messaggio */